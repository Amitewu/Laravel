				...
				<div class="card-body">
					...
					<table class="table table-broder">
						  ...
						  <tbody>
						      ...
						      <td><img src="{{ asset('uploads/product_photos') }}/{{$deleted_products->product_image}}" alt="no photos found" width="50"></td>
