            ...
            <div class="row">
                <div class="col-lg-3 col-md-8 col-sm-12">
                    <div class="footer-widget about-widget">
                        ...
                        <p>This is one of the content made my Amit Roy using laravel </p>
                        <div class="cards">
                ...
                <div class="col-lg-2 col-md-4 col-sm-6">
                    <div class="footer-widget">
                        ...
                        <div class="text-box">
                            <p>Roy  </p>
                            <p>4/2, outer circular road, Dhaka-1217 </p>
                            <p>+8801744397456</p>
                            <p>ramit8339@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made  <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="ramit8339@gmail.com" target="_blank">AmitRoy</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
</p>
        </div>
    </footer>
